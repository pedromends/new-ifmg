    ...
    <main class="flex justify-start items-center px-10 max-sm:mt-20">
        <div class="flex flex-col gap-10 px-20 w-full max-sm:px-0">
            ...
            <div class="flex items-center justify-between">
                <h1
                    class="text-3xl text-black font-semibold underline underline-offset-2 decoration-8 decoration-maingreen">
                    Documentos</h1>
                <v-dialog max-width="500">
                    <template v-slot:activator="{ props: activatorProps }">
                        <v-btn v-bind="activatorProps" color="#2F9E40" text="Inserir novo documento"
                            variant="flat"></v-btn>
                    </template>
                    ...
                    <template v-slot:default="{ isActive }">
                        <v-card title="Inserir Documento">
                            <v-form class="p-4 md:p-5 space-y-4">
                                <v-text-field v-model="docTitle" :rules="[rules.text]"
                            ...
                            <v-card-actions>
                                ...
                                <v-btn class="me-4" color="#2F9E40" type="submit" dark @click.prevent="createPdf()">
                                    Salvar
                                </v-btn>
        ...
        <div id="default-modal" tabindex="-1" aria-hidden="true" v-if="isAdmin"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div id="tip-div" class="border-2 border-transparent p-2 col-span-2">
                            <label for="tip" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Título do
                                Documento</label>
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5"
                        ...
                        <div id="tip-div" class="border-2 border-transparent p-2 col-span-2">
                            <label for="tip" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Arquivo
                                PDF</label>
