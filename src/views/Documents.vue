    ...
    <main class="flex justify-start items-center px-10 max-sm:mt-20">
        <div class="flex flex-col gap-10 px-20 w-full max-sm:px-0">
            ...
            <div class="flex justify-between">
                <h1 class="text-2xl text-black font-semibold underline underline-offset-2 decoration-8 decoration-maingreen">Documentos</h1>
                <button class="text-white bg-maingreen hover:bg-govblue focus:ring-4 focus:outline-none focus:ring-red-600 font-medium rounded-lg text-sm px-3 py-2 text-center transition duration-200"
