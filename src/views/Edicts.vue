    ...
    <main class="flex justify-start items-center px-10 ">
        <div class="flex flex-col gap-10 px-20 w-full">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <div id="tip-div" class="border-2 border-transparent p-2 col-span-2">
                                    ...
                                    <input
                                        ...
                                        type="text" id="tip" placeholder="Edital para professores..." required />
            ...
            <div class="flex flex-col gap-5 text-maingray">
                <div>
                    <ul class="flex flex-col gap-4 text-blue-700 w-2/5">
                        <li v-for="(edict, i) in edicts" :key="i" :href="edict.link"  class="flex items-center gap-1">
                            ...
                            <a target="_blank" class="hover:underline">{{ edict.title }}</a>
                        </li>
                    </ul>
                </div>
