        ...
        <div class="flex flex-col gap-10 px-20 w-full">
            ...
            <div class="flex flex-col gap-5 text-maingray">
                <div class=""
                    ...
                    <ul class="flex flex-col gap-5 divide divide-maingreen rounded-xl h-180 px-10 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-maingreen">
