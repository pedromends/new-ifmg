    ...
    <nav class="w-full relative font-opensans max-lg:hidden">
        ...
        <section class="bg-govblue flex justify-between items-center py-1 text-lightgray font-raleway font-bold uppercase">
            <div class="flex justify-end items-center text-center gap-5 text-xs ml-36">
                ...
                <a class="pr-2 hover:text-red-600" href="">COMUNICA BR</a>
                <a class="pr-2 hover:text-red-600" href="">LEGISLAÇÃO</a>
            </div>
            <div class="flex justify-center items-center gap-3 text-xs pr-20 mr-16">
                <a class="pl-3 hover:text-red-600" href="">PARTICIPE</a>
                <a class="pl-3 hover:text-red-600" href=""> ACESSO À INFORMAÇÃO</a>
                <a class="pl-3 hover:text-red-600" href="">ÓRGÃOS DO GOVERNO</a>
            </div>
        </section>
        ...
        <section class="flex justify-between bg-maingreen">
            <div class="flex justify-between items-center gap-8 px-20 text-lightgray text-sm">
                <a class="hover:underline" href="#">INGRESSO</a>
                <a class="hover:underline" href="#">NOSSOS CURSOS</a>
                <a class="hover:underline" href="#">ACESSO À INFORMAÇÃO</a>
            </div>

            <div class="flex justify-between items-center gap-5">
                <div class="flex items-center gap-3 px-5">
                    <a href="https://www.instagram.com/poloifmg/" class="hover:bg-govblue rounded-2xl transition duration-200" target="_blank">
                        <img alt="Instagram" class="h-8" :src="require('@/assets/icons/insta.svg')"/>
                    </a>
                    <a href="" class="hover:bg-govblue rounded-2xl transition duration-200" target="_blank">
                ...
                <button class="bg-white mr-16 p-4 text-maingreen tracking-wide text-sm hover:underline hover:text-govblue">ACESSO P/ADM</button>
            </div>        
        </section>
        
        <section class="flex justify-between items-center">
            <div class="flex text-sm text-maingray gap-5 p-4 ml-14 max-lg:p-0">
                <a class="hover:text-black" href="#home">INÍCIO</a>
                <a class="hover:text-black" href="#aboutus">QUEM SOMOS</a>
                <a class="hover:text-black" href="#advantages">VANTAGENS</a>
                <a class="hover:text-black" href="#news">NOTÍCIAS</a>
                <a class="hover:text-black" href="#courses">NOSSOS CURSOS</a>
            </div>
            <div class="flex text-sm text-maingray gap-5 p-2 mr-14 max-lg:p-0">
                <a class="hover:text-black" href="#researchers">PESQUISADORES</a>
                <a class="hover:text-black" href="#edicts">EDITAIS</a>
                <a class="hover:text-black" href="#docs">DOCUMENTOS</a>
                <a class="hover:text-black" href="#capacitation">CAPACITAÇÃO</a>
                <a class="hover:text-black" href="#contact">CONTATO</a>
            </div>
        </section>
    </nav>
    <!-- <nav>
