<template lang="">
    <nav>
        <section class="bg-white w-full hidden max-lg:inline max-lg:fixed z-10">
        ...
        <section id="drawer-navigation" class="hidden max-lg:inline fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-maingreen dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
            <div class="flex items-center gap-3 mt-3">
                <img :src="require('@/assets/icons/if.png')" class="w-12 p-1 rounded-lg bg-white " alt="logo"/>
                <h5 id="drawer-navigation-label" class="text-sm font-semibold text-white">Polo de Inovação - IFMG</h5>
                <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" class="text-maingray bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
