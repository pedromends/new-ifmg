            ...
            <section class="px-20 max-lg:px-5">
                <div href="#" target="_blank" class="flex bg-white max-lg:flex-col justify-between items-center gap-48 border-2 rounded-3xl border-gray-100 hover:shadow-2xl transition duration-300">
                    <div class="flex flex-col gap-3 pl-10 max-lg:px-3">
                        <span class="border-2 border-maingreen rounded-lg w-40 justify-center px-2 py-1 max-lg:mt-6 4xl:mx-auto flex items-center">
                            <div class="h-2.5 bg-black rounded-full w-24 self-center"></div>
                        </span>
                        <h1 class="w-80 max-lg:w-auto text-2xl font-bold mt-2 flex flex-col gap-4 justify-start">
                        ...
                        <h1 class="w-80 max-lg:w-auto text-2xl font-bold mt-2 flex flex-col gap-1 justify-start">
                    ...
                    <div class="flex items-center justify-center w-full h-48 bg-maingreen sm:w-96 dark:bg-gray-700">
