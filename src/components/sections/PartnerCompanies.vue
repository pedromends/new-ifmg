    ...
    <section id="ourclients" class="flex justify-center items-center bg-lightgray py-10">
        <div class="bg-whitecircle bg-no-repeat bg-center min-h-160 flex flex-col items-center">
            <div class="flex flex-col items-center justify-center gap-10 h-160 overflow-y-auto  max-sm:mx-12">
                ...
                <div v-if="projects != undefined" class="grid grid-cols-6 max-sm:grid-cols-1 justify-center gap-6 px-12 items-center overflow-y-auto py-5 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-maingreen">
