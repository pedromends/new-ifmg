<template lang="">
    <section class="flex flex-col px-16 py-36 gap-16 bg-lightgray">
        ...
        <div class="flex max-lg:flex-col overflow-auto justify-center gap-5 text-black relative">
            ...
            <!-- Inserir opção de busca -->
            <!-- Filtrar: <input>, nome, área, curso, campus -->
        ...
        <button class="px-5 py-2 bg-white text-maingreen w-36 mx-auto rounded-lg font-bold border-2 border-maingreen hover:bg-maingreen hover:text-white transition duration-300">Ver Mais</button>
    </section>
</template>
<script>
