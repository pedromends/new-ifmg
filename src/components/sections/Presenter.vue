<template lang="">
    ...
    <section id="home" class="bg-campus bg-cover bg-no-repeat bg-center">
        <div class=" flex flex-col justify-center items-center p-10 gap-96 rounded-b-3xl relative">
            ...
            <div class="flex max-lg:flex-col gap-4 p-10 bg-gray-200 border-16 max-lg:border-0 border-white rounded-3xl absolute top-100 max-lg:top-[33rem] max-lg:px-10">
