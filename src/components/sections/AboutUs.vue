        ...
        <div class="flex justify-center px-12 max-lg:px-8">
            <div class="flex max-lg:flex-col gap-24">
                <div class="flex flex-col w-140 max-lg:w-auto gap-8 max-lg:mt-10">
                    ...
                    <p class="w-full text-maingray">O Polo de Inovação IFMG atua na aproximação das empresas com o setor acadêmico, desenvolvendo projetos relacionados a área de Mobilidade e Sistemas Inteligentes, assim como em diversas subáreas, sendo algumas delas: gestão de ativos móveis, otimização de processos, transporte e sistemas automotivos.</p>
                    <!-- Ir para página explicando tudo sobre o polo -->
                    <router-link to="/institutional" class="bg-maingreen text-white w-40 py-3 rounded-lg border-2 border-white font-semibold hover:border-maingreen hover:bg-white hover:text-maingreen transition duration-300 text-center">Saiba Mais</router-link>
                </div>
                <div>
